...
<div id="user-<?php echo $user->ID; ?>" class="author-block">
	...
	<h3><a href="<?php echo get_author_posts_url($user->ID); ?>"><?php echo $user_info->display_name; ?></a> - <?php printf( _nx( '%n post', '%n posts', $num_posts, 'number of posts', 'simple-user-listing' ), $num_posts ); ?>
	</h3>

	<?php echo ucwords(get_user_meta( $user->ID, 'first_name', true )) . ucwords(get_user_meta( $user->ID, 'last_name', true )); ?>
