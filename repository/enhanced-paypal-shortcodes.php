...
switch($atts['type']):
	...
	$code = '
		...
		$code .= '<input type="submit" value="'.__("Pay for this Course", "learndash").'" class="btn-join" id="btn-join">';
...
endswitch;
return apply_filters('learndash_payment_button', $code, array('code' => $code, 'atts' => $atts)) ;
}
}
